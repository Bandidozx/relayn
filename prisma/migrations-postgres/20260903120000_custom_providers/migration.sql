...
-- `custom` = false and "apiKeyCipher" NULL means "credential still comes from env", which is
...
ADD COLUMN     "apiKeyCipher" TEXT,
ADD COLUMN     "apiKeyHint" TEXT NOT NULL DEFAULT '',
ADD COLUMN     "extraHeaders" TEXT NOT NULL DEFAULT '',
